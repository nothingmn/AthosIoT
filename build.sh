...
NEOPIXELSOURCE=$BUILDROOT/NEOPIXEL/$BINFILE
IRRECEIVERSOURCE=$BUILDROOT/IRRECEIVER/$BINFILE
IRRECEIVER_NEOPIXELSOURCE=$BUILDROOT/IRRECEIVER_NEOPIXEL/$BINFILE
...
NEOPIXELDEST=$OUTROOT/NEOPIXEL_$BINFILE
IRRECEIVERDEST=$OUTROOT/IRRECEIVER_$BINFILE
IRRECEIVER_NEOPIXELDEST=$OUTROOT/IRRECEIVER_NEOPIXEL_$BINFILE
...
cp $NEOPIXELSOURCE $NEOPIXELDEST
cp $IRRECEIVERSOURCE $IRRECEIVERDEST
cp $IRRECEIVER_NEOPIXELSOURCE $IRRECEIVER_NEOPIXELDEST